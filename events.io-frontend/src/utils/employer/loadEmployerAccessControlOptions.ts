...
import { employerAccessControlService } from '@/services';
...
export const loadEmployerAccessControlRoleOptions = async (
  searchQuery: string,
  ...
  const response =
    await employerAccessControlService.getEmployerAccessControlRole({
