...
import { useCreateSchoolEventComment } from '@/hooks/shared';
...
const UniEventsDiscussionsArea = ({
  commentsData,
  loading,
  uid,
  filterDTO,
  ...
  const { mutate: postComment } = useCreateSchoolEventComment({
    onSuccess: () => {
...
export default UniEventsDiscussionsArea;
