      ...
      <div className={styles.detailsContainer}>
        ...
        <div className={styles.worthWrapper}>
          ...
          <div className={styles.worthBox}>
            <Typography variant="h2">
              {`${profileData?.workDetails.monthlySalary ?? 'N/A'} ${profileData?.workDetails.currency || ''
                }/m `}
            </Typography>
          ...
          <div className={[styles.worthBox, styles.noBorder].join(' ')}>
            <Typography variant="h2">
              {`${profileData?.workDetails.hourlyRate ?? 'N/A'} ${profileData?.workDetails.currency || ''
                }/h `}
            </Typography>
        ...
        <div className={styles.aboutContainer}>
          ...
          <Typography
            ...
            dangerouslySetInnerHTML={{ __html: str(profileData?.personalDetails.about || 'No About provided') }}
          />
