  ...
  const conditionalSideBar = () => {
    if (
      ...
      return isLargeScreen ? (
        <LargeScreenSidebar sideBarContent={sideBarContent} handleContactSupport={handleContactSupport} />
      ) : (
        <SmallScreenSidebar sideBarContent={sideBarContent} handleContactSupport={handleContactSupport} />
      );
    }
  };
